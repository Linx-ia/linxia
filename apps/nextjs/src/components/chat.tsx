      ...
      <div className="transition-width relative h-full w-full flex-1 overflow-auto">
        ...
        >
          <div className="flex-1 overflow-hidden">
            <div className="react-scroll-to-bottom h-full">
                            ...
                            <div className="flex-col gap-1 md:gap-3">
                              <div className="flex max-w-full flex-grow flex-col">
                                <div
                                  ...
                                  data-message-id="aaa2cf50-4df0-4a7e-994c-aa02352698a8"
                                  dir="auto"
                                  className="text-message flex min-h-[20px] w-full flex-col items-start gap-2 overflow-x-auto whitespace-pre-wrap break-words [.text-message+&]:mt-5"
                                >
                      ...
                      <div className="m-auto px-3 py-2 text-base md:px-5 lg:px-1 xl:px-5">
                        <div className="mx-auto flex flex-1 gap-4 text-base md:max-w-3xl md:gap-6 lg:max-w-[40rem] xl:max-w-[48rem]">
                          <div className="relative flex flex-shrink-0 flex-col items-end">
                            <div>
                              <div className="jpt-0 pt-0.5">
                                <div className="gizmo-bot-avatar flex h-6 w-6 items-center justify-center overflow-hidden rounded-full">
          ...
          <div className="w-full pl-0 pr-0 dark:border-white/20 md:w-[calc(100%-.5rem)] md:border-transparent md:pt-0 md:dark:border-transparent">
                ...
                <form className="w-full">
                  <div className="relative flex h-full max-w-full flex-1 flex-col">
                    ...
                    <div className="flex w-full items-center">
                      <div className="flex w-full flex-col gap-1.5 rounded-[26px] bg-white p-1.5 transition-colors">
                        <div className="flex items-end">
                          <div className="flex min-w-0 flex-1 flex-col">
                            <textarea
                              id="prompt-textarea"
                              data-id="85248cd2-297e-417f-99ca-9038c39cd006"
                              dir="auto"
                              placeholder="Mensagem ChatGPT"
                              className="m-0 h-[40px] max-h-[25dvh] resize-none overflow-y-hidden border-0 bg-transparent p-2 px-0 ring-0 focus:border-none focus:ring-0"
                            ></textarea>
                          </div>
                          <button
                            disabled
            ...
            <div className="text-token-text-secondary relative px-2 py-2 text-center text-xs md:px-[60px]">
              <span>
                ChatGPT pode cometer erros. Considere verificar informações
                importantes.
              </span>
            </div>
          </div>
